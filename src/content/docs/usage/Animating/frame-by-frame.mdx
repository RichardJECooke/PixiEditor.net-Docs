...
A single frame is just an image. When you create multiple images, that are just slightly different from the previous and display them one after another fast enough, they'll create a illusion of motion. So called "animation".
